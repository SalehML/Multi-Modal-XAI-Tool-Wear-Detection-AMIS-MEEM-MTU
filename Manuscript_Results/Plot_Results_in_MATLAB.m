...
figure(5)
plot(ROC_Full(2,:), ROC_Full(1,:), 'r', LineWidth = 2)
hold on 
plot(line(1,:), line(2,:), 'k--', LineWidth = 2)
hold on 
plot(True_Performance_1(1,:), True_Performance_1(2,:), 'b--', LineWidth = 2)
hold on 
plot(True_Performance_2(1,:), True_Performance_2(2,:), 'b--', LineWidth = 2)
legend('Trained Model Performance', 'Untrained Model Performance', 'Ideal Model Performance', 'FontSize', 12)
xlabel('FPR', 'FontSize', 12)
ylabel('TPR', 'FontSize', 12)

figure(6)
plot(ROC_CNN_I(2,:), ROC_CNN_I(1,:), 'r', LineWidth = 2)
hold on 
plot(line(1,:), line(2,:), 'k--', LineWidth = 2)
hold on 
plot(True_Performance_1(1,:), True_Performance_1(2,:), 'b--', LineWidth = 2)
...
figure(7)
plot(ROC_CNN_II(2,:), ROC_CNN_II(1,:), 'r', LineWidth = 2)
hold on 
plot(line(1,:), line(2,:), 'k--', LineWidth = 2)
hold on 
plot(True_Performance_1(1,:), True_Performance_1(2,:), 'b--', LineWidth = 2)
...
figure(8)
plot(ROC_RNN(2,:), ROC_RNN(1,:), 'r', LineWidth = 2)
hold on 
plot(line(1,:), line(2,:), 'k--', LineWidth = 2)
hold on 
plot(True_Performance_1(1,:), True_Performance_1(2,:), 'b--', LineWidth = 2)
...
accuracy = accuracy{2:11, 2};

accuracy_val = readtable('Val_accuracy_Info_7.xlsx');

accuracy_val = accuracy_val{2:11, 2};
...
shap_latent_case_I = readtable('shap_latent_real_val_pd.xlsx');

shap_latent_case_I = shap_latent_case_I{2:5, 2:end};
...
shap_latent_case_II = readtable('shap_latent_real_pd.xlsx');
